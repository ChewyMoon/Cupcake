// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DateTimeProperty.cs" company="ChewyMoon">
...
// </copyright>
// <summary>
//   Features available for the DateTime property.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace numl.Model
{
    ...
    public class DateTimeProperty : Property
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="DateTimeProperty" /> class. Default constructor.
        /// </summary>
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="DateTimeProperty" /> class. Constructor.
        /// </summary>
        /// <param name="portion">
        ///     The portion.
        /// </param>
        ...
        private void Initialize(DatePortion portion)
        {
            ...
            {
                this.Features |= DateTimeFeature.Year | DateTimeFeature.Month | DateTimeFeature.Day;
            }

            if (portion.HasFlag(DatePortion.DateExtended))
            {
                this.Features |= DateTimeFeature.DayOfYear | DateTimeFeature.DayOfWeek;
            }

            if (portion.HasFlag(DatePortion.Time))
            {
                this.Features |= DateTimeFeature.Hour | DateTimeFeature.Minute;
            }

            if (portion.HasFlag(DatePortion.TimeExtended))
            {
                this.Features |= DateTimeFeature.Second | DateTimeFeature.Millisecond;
            }
        }
